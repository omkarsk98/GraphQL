...
export declare class ApolloServer extends ApolloServerBase {
    ...
    getMiddleware({ path, cors, bodyParserConfig, disableHealthCheck, onHealthCheck, }?: GetMiddlewareOptions): import("compose-middleware").RequestHandler<import("express-serve-static-core").Request, import("express-serve-static-core").Response, any>;
}
