...
class EngineReportingExtension {
    ...
    requestDidStart(o) {
        ...
        if (this.options.sendHeaders) {
            makeHTTPRequestHeaders(this.trace.http, o.request.headers, this.options.sendHeaders);
        ...
        if (o.variables) {
            this.trace.details = makeTraceDetails(o.variables, this.options.sendVariableValues, o.queryString);
        }
